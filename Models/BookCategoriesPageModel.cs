...
namespace Kerekes_Ida_Roberta_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> ?AssignedCategoryDataList;

        public void PopulateAssignedCategoryData(Kerekes_Ida_Roberta_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Kerekes_Ida_Roberta_Lab2Context context,
